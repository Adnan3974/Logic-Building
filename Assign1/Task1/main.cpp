    ...
    while(true) {  
        ...
        if(choice==1){
            ...
            if (pin<123456 || pin>234567)
            {
                ...
                cin >> choice;
                while (cin.fail()){
                    cout << "Invalid input! Enter integer value 1-13 : ";
                    cin >> choice;
                }
                while(choice<1 || choice>13 || choice==2){
                    cout << "Enter choice b/w 1-13 other than 2: ";
                    cin >> choice;
                }
        ...
        while(true){
            ...
            int choice;
                ...
                while(choice<1 || choice>5){
                    cout << "Enter choice b/w 1-5 : ";
                    cin >> choice;
                }

                switch(choice){
                    case 1: order.addItemInOrder();
                    break;
                    case 2: order.removeItemFromOrder();
                    break;
